        ...
        <ThemeProvider theme={theme}>
            <Box sx={{ flexGrow: 1 }}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={3} mt={2}>
                        <TextField name="patientLname" value={patientLname}
                            fullWidth
                    ...
                    <Grid item xs={3} mt={2} direction='row' textAlign='left' justifyContent='center'>
                        ...
                        <FormControl>
                            ...
                            <RadioGroup
                                ...
                                name="gender"
                                value={gender}>
                                <FormControlLabel value="female" control={<Radio />} label="Female" onChange={handleChange(setGender)} />
                                <FormControlLabel value="male" control={<Radio />} label="Male" onChange={handleChange(setGender)} />
                            </RadioGroup>
                        </FormControl>
                        ...
                        <Box sx={{ minWidth: 120 }}>
                            <FormControl fullWidth required>
                                ...
                                <Select
                                    ...
                                    helperText={error.civilstatus}
                                    onChange={handleChange(setCivilStatus)}
                                >

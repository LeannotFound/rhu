...
export default function AddVisits({ selectedPatient, handleCloseAddVisitModal }) {
    ...
    const initials = `${selectedPatient && selectedPatient.lastName ? selectedPatient.lastName[0] : ''}${selectedPatient && selectedPatient.firstName ? selectedPatient.firstName[0] : ''}`;
                ...
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <Box mb={2}>
                        ...
                        <Grid container>
                            ...
                            <Grid container xs={6} margin={2}>
                                <Paper>
                                 
                                    <Box display="flex" border={1} justifyContent="center" padding={2}  fontWeight={700}>
                                    Prescription
                                             </Box>
